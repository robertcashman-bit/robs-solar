...
class SimulatorAdapter(InverterAdapter):
    ...
    def __init__(self, seed: int = 42) -> None:
        ...
        self._bands: list[TouBand] = [
            TouBand(slot=1, start="00:00", end="06:00", target_soc_pct=100,
                    grid_charge_enabled=True, power_w=3000),
            TouBand(slot=2, start="06:00", end="11:00", target_soc_pct=40,
                    grid_charge_enabled=False, power_w=8000),
            TouBand(slot=3, start="11:00", end="16:00", target_soc_pct=40,
                    grid_charge_enabled=False, power_w=8000),
            TouBand(slot=4, start="16:00", end="19:00", target_soc_pct=80,
                    grid_charge_enabled=False, power_w=8000),
            TouBand(slot=5, start="19:00", end="22:00", target_soc_pct=40,
                    grid_charge_enabled=False, power_w=8000),
            TouBand(slot=6, start="22:00", end="24:00", target_soc_pct=40,
                    grid_charge_enabled=False, power_w=8000),
        ]
        self._battery = {
            "charge_current_a": 50,
