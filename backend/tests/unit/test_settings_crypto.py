...
def test_open_json_ignores_invalid_token() -> None:
    assert open_json("enc:v1:not-a-real-fernet-token") == {}


def test_open_json_ignores_invalid_plaintext() -> None:
    assert open_json("not-json") == {}
