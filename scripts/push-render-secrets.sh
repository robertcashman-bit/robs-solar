...
KEYS=(
  ADMIN_USERNAME ADMIN_EMAIL ADMIN_PASSWORD VIEWER_USERNAME VIEWER_PASSWORD
  ...
  TRUELAYER_CLIENT_ID TRUELAYER_CLIENT_SECRET TRUELAYER_REDIRECT_URI TRUELAYER_ENVIRONMENT
  LUNCHFLOW_API_KEY
  TESLA_CLIENT_ID TESLA_CLIENT_SECRET TESLA_REFRESH_TOKEN TESLA_ENERGY_SITE_ID
  OIDC_ENABLED OIDC_ISSUER_URL OIDC_CLIENT_ID OIDC_CLIENT_SECRET OIDC_REDIRECT_URI OIDC_ADMIN_EMAILS
